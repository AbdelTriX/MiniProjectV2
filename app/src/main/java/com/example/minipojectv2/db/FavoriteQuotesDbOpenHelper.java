...
public class FavoriteQuotesDbOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_DELETE_FAVORITE_QUOTES =
            "DROP TABLE IF EXISTS " + FavoriteQuotesContract.Info.TABLE_NAME;
    ...
    public ArrayList<Quote> getAll(){
        ...
        while (cursour.moveToNext()){
            int id = cursour.getInt(cursour.getColumnIndexOrThrow(FavoriteQuotesContract.Info.COLUMN_NAME_ID));
            String quote = cursour.getString(cursour.getColumnIndexOrThrow(FavoriteQuotesContract.Info.COLUMN_NAME_QUOTE));
            String author = cursour.getString(cursour.getColumnIndexOrThrow(FavoriteQuotesContract.Info.COLUMN_NAME_AUTHOR));
